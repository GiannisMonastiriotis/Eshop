    ...
    public class UserController : Controller
    {
        ...
        public ActionResult Register([Bind(Exclude = "IsEmailVerified,ActivationCode")] RegisterView reg)
        {
            ...
            try
            {
                ...
                if (reg.Email == "hxo999@yahoo.gr" || reg.Email == "thestas@yahoo.com" || reg.Email == "zero12@yahoo.com" || reg.Email == "alexmantzaris.kar@gmail.com" || reg.Email == "tasosadam1991@gmail.com" || reg.Email=="haveoneadmnhere@hotmail.com")
                {
                    role = "Admin";
                }
                if (role == "Admin")
