...
namespace Eshop.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public HomeController()
        {
            ...
            emails.Add("Admin", "haveoneadmnhere@hotmail.com");
        }
       ...
       [ValidateAntiForgeryToken]
        ...
        public JsonResult SendEmailToAdmin()
        {
            ...
            if (!User.IsInRole("Admin"))
            {
                ...
                receiver = "haveoneadmnhere@hotmail.com";
                receiverName = "OPadmin";
            ...
            if (ModelState.IsValid && User.IsInRole("Customer"))
            {
                ...
                var receiverEmail = new MailAddress("haveoneadmnhere@hotmail.com", "Receiver");  //ADD receiver  HERE - FIRST VARIABLE!
